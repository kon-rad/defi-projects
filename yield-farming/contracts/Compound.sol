...
contract Compound {
    ...
    // indicate to compound what token you want to use as collatoral
    ...
    // No view keyword because borrowBalanceCurrent() can be called in a tx, adn Solidity complains if view
